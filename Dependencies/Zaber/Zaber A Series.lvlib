...
See http://www.zaber.com/wiki/Software/ASCII_Labview_Driver for more information.  </Property>
	...
	<Item Name="Private" Type="Folder">
		...
		<Item Name="All Commands.ctl" Type="VI" URL="../All Commands.ctl"/>
		...
		<Item Name="Read (Multiple Responses).vi" Type="VI" URL="../Read (Multiple Responses).vi"/>
		<Item Name="Read (Single Response).vi" Type="VI" URL="../Read (Single Response).vi"/>
		<Item Name="Request.vi" Type="VI" URL="../Request.vi"/>
